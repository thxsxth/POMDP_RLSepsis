...
(
  ...
  left join me me72
    ...
    (
      ...
      and ab_tbl.antibiotic_time <= DATETIME(DATE_ADD(DATE(me72.charttime), INTERVAL 3 DAY))
      )
      OR
      (
      ...
      and ab_tbl.antibiotic_time < DATETIME(DATE_ADD(DATE(me72.chartdate),interval 4 DAY))-- could equally do this with a date_trunc, but that's less portable
      )
    )
  ...
  left join me me24
    ...
    (
      -- if charttime is available, use it
      (
          ab_tbl.antibiotic_time > DATETIME(DATE_SUB(DATE(me24.charttime),interval 1 DAY))
      ...
      and ab_tbl.antibiotic_time <= DATETIME(DATE_ADD(DATE(me24.chartdate),interval 1 day))
      )
    )
)
, ab_laststg as
